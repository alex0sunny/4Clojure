...
;; and returns a sequence enumerating all strings in the language recognized by the DFA. 
;; Note: Although the DFA itself is finite and only recognizes finite-length strings 
;; it can still recognize an infinite set of finite-length strings. 
;; And because stack space is finite, make sure you don't get stuck in an infinite loop 
;; that's not producing results every so often!
...
;; (= #{"hi" "hey" "hello"}
;;     (set (analyze-dfa '{:states #{q0 q1 q2 q3 q4 q5 q6 q7}
...
;;     (set (analyze-dfa '{:states #{q0 q1 q2 q3 q4}
;;                         :alphabet #{v w x y z}
;;                         :start q0
;;                         :accepts #{q4}
...
;;  (let [res (take 2000 (analyze-dfa '{:states #{q0 q1}
;;                                      :alphabet #{0 1}
;;                                      :start q0
;;                                      :accepts #{q0}
...
;;  (let [res (take 2000 (analyze-dfa '{:states #{q0 q1 q2 q3 q4 q5 q6 q7 q8 q9}
